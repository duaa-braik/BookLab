        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CartItem_Quantity", "[Quantity] <= 12");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Discount_DiscountPercentage", "[DiscountPercentage] <= 100");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItem_Quantity", "[Quantity] <= 12");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Review_Rating", "[Rating] <= 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Author",
                column: "FirstName")
                .Annotation("SqlServer:Include", new[] { "LastName" });

            migrationBuilder.CreateIndex(
                name: "IX_Author_UpdatedBy",
                table: "Author",
                column: "UpdatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartStatus_CreatedBy",
                table: "CartStatus",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_CartStatus_UpdatedBy",
                table: "CartStatus",
                column: "UpdatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatus_UpdatedBy",
                table: "OrderStatus",
                column: "UpdatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Publisher_CreatedBy",
                table: "Publisher",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Publisher_UpdatedBy",
                table: "Publisher",
                column: "UpdatedBy");
